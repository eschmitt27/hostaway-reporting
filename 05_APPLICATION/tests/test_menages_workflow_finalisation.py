...
def test_14_numero_reutilise_sur_un_autre_mois_n_annule_rien(tmp_db):
    ...
    disparaissait. Le même numéro sur une autre période n'est pas une version : rien n'est
    annulé (la coexistence est prouvée dans test_factures_document_incoherent_numero_reutilise)."""
    _fournisseur_minimal(tmp_db)
