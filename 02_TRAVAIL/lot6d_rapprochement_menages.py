...
import argparse, sys, os, hashlib, datetime, collections, unicodedata, warnings
...
_ap.add_argument("--source", choices=("SQLITE",), default="SQLITE",
                 help="SQLITE uniquement. La lecture des classeurs legacy Lot6a/6b/6c a ete "
                      "supprimee : plus aucun appelant ne l'empruntait et les classeurs sources "
                      "ne sont plus regeneres.")
...
# `decl`, `m04_alimente` et `src_interne` viennent de SQLite (bloc plus haut).
