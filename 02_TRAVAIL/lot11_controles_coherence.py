...
def main():
    ...
    if len(df_taux_hist) == 0:
        _ctrl(ctrl_rows, "REF", "REF_Taux_Commission", None,
              ...
              "REF_Taux_Commission absent ou vide. Aucun taux non date autorise; facture finale interdite.",
    ...
    if len(df_gest_hist) == 0:
        _ctrl(ctrl_rows, "REF", REF_GESTION_LOGEMENTS_HIST_SHEET, None,
              ...
              "REF_Gestion_Logements_Hist absent ou vide. Le proprietaire applicable ne peut pas etre resolu; facture finale interdite.",
